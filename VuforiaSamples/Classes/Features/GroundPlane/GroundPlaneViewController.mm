    ...
    switch(statusInfo) {
        ...
        case Vuforia::TrackableResult::INITIALIZING:
            ...
            if (Vuforia::getActiveFusionProvider() ==
                Vuforia::FUSION_PROVIDER_TYPE::FUSION_PROVIDER_PLATFORM_SENSOR_FUSION)
            {
...
- (bool) doInitTrackers
{
    ...
    // the FUSION_OPTIMIZE_MODEL_TARGETS_AND_SMART_TERRAIN enum
    ...
    if (![vapp setFusionProviderType:
        Vuforia::FUSION_PROVIDER_TYPE::FUSION_OPTIMIZE_MODEL_TARGETS_AND_SMART_TERRAIN])
    {
        return NO;
    }
